...
Contributors: simplepress, usermrpapa, yellowswordfish
...
Recently available on WordPress.org, it is easy to get started but filled with advanced features when you need them.

And, if that's not enough, there are more than 60 premium add-ons available on the [Simple-Press site](https://simple-press.com/store/add-ons/)!
...
***Warning: Updating from 5.x to 6.x should be done manually!  See [this document](https://simple-press.com/documentation/installation/upgrading/upgrading-from-version-5-x-to-version-6-x/) for details****

= 6.0.6 =
Fix
	* 5993: Locked forums/topics were allowing user to post despite being locked
